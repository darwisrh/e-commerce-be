...
// CONTROLLERS
import { createProduct, getAllProducts, getOneProducts, deleteOneProduct } from "../controllers/product.controller"
...
prodRoutes.delete("/delete-one-product/:id", auth, deleteOneProduct)